...
const (
	Query_Params_FullMethodName     = "/kopi.blockspeed.Query/Params"
	Query_Blockspeed_FullMethodName = "/kopi.blockspeed.Query/Blockspeed"
)
...
func (c *queryClient) Blockspeed(ctx context.Context, in *QueryBlockspeedRequest, opts ...grpc.CallOption) (*QueryBlockspeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Blockspeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Blockspeed(context.Context, *QueryBlockspeedRequest) (*QueryBlockspeedResponse, error) {
...
func _Query_Blockspeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Blockspeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
