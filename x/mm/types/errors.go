...
var (
	...
	ErrCollateralDepositLimitExceeded = sdkerrors.Register(ModuleName, 1112, "deposit limit for collateral denom has been exceeded")
	ErrRedemptionFeeTooLow            = sdkerrors.Register(ModuleName, 1113, "redemption fee must not be lower than minimum fee")
	ErrRedemptionFeeTooHigh           = sdkerrors.Register(ModuleName, 1114, "redemption fee must not be larger than maximum fee")
	ErrZeroCAssets                    = sdkerrors.Register(ModuleName, 1115, "zero c assets minted")
	ErrCannotWithdrawCollateral       = sdkerrors.Register(ModuleName, 1116, "cannot withdraw collateral amount")
	...
	ErrCollateralBorrowLimitExceeded  = sdkerrors.Register(ModuleName, 1120, "borrow limit given by collateral exceeded")
)
